...
def process_madlib(mad_lib):
    ...
    stringLocation = 0
    boxSize = 4 # box that is the size of NOUN and VERB

    while stringLocation < len(mad_lib):

        word = mad_lib[stringLocation : stringLocation + boxSize]
        processedWord = word_transformer(word)
